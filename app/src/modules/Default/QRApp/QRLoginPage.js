              ...
              <div className="card-body p-4 text-center">
                ...
                <div className='mb-2'>
                  ...
                  <div className="form-outline mb-2">
                    ...
                    <input type="email" placeholder="exemple@email.com" className='form-control form-control-lg' required />
                  </div>

                  <div className="form-outline mb-2">
                    <label className='form-label text-left fs-5'>Mot de passe</label>
                    <input type="password" className='form-control form-control-lg' placeholder="••••••••••••" id="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
                  </div>
                  ...
                  */}
                  ...
                  <button className="btn btn-lg btn-outline-secondary w-100 d-flex align-items-center justify-content-center">
                ...
                {continuePath ?
                  (
                    <div>
                      ...
                      <button
                        className="btn btn-lg btn-primary w-100 mt-2 mb-2"
